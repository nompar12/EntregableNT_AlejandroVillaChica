    ...
    if id_cliente in clientes and id_producto in productos:
        if cantidad <= productos[id_producto]['cantidad']:
            if id_cliente not in ventas:
                ventas[id_cliente] = []
            venta = {"id_producto": id_producto, "cantidad": cantidad}
        ...
        if cliente_actual:
            while True:
                ...
                if opcion_compra == '1':
                    ...
                    if cliente_actual in ventas:
                        for venta in ventas[cliente_actual]:
                            nombre_producto = productos[venta['id_producto']]['nombre']
